...
| 작업 | 주기 |
|------|------|
| 가격 알림 체크 | 미국 장중 30분마다 (평일) |
| 영상 알림 갱신 | 매일 KST 06:00 |
| 데일리 신문 자동 발행 | 매일 KST 07:00 |
| 카카오 데일리 브리핑 | KST 월~금 08:00 |

> ⚠️ 서버 시간은 UTC다. 아침 잡은 UTC 기준 "전날"이라 cron 요일도 하루 당겨야 한다
> (KST 월~금 = UTC 일~목 `0-4`). 자세한 건 [crontab.txt](crontab.txt) 주석 참고.
